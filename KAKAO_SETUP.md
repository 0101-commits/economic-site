...
매일 **오전 10시 / 오후 3시 / 오후 6시(KST) 무렵** 에 `data.json` 시황 요약이 **본인 카카오톡("나와의 채팅")** 으로
자동 발송됩니다. (10시=아침 / 15시=오후 / 18시=마감. 제목은 'M/D(요일) 시황' 공통입니다.)
...
## 참고 / 문제 해결
- **발송 시각**: 매일 약 10:17 / 15:17 / 18:17 KST(정각 혼잡 회피, 누락 시 42분 보강). best-effort 라 몇 분 더 늦을 수 있습니다.
