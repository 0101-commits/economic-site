# 📲 카카오톡 매일 시황 요약 (10·15·18시) — 설정 가이드

매일 **오전 10시 / 오후 3시 / 오후 6시(KST)** 에 `data.json` 시황 요약이 **본인 카카오톡("나와의 채팅")** 으로
자동 발송됩니다. (10시=아침 / 15시=오후 / 18시=마감 — 발송 시각에 맞춰 제목이 자동으로 바뀝니다.)
...
## 테스트 (즉시 발송)
설정 후 바로 확인하려면:
**GitHub → Actions → "KakaoTalk Daily Digest (10·15·18 KST)" → Run workflow** 클릭
...
## 참고 / 문제 해결
- **발송 시각**: 매일 10:00 / 15:00 / 18:00 KST. GitHub Actions 스케줄은 UTC·best-effort 라 몇 분 늦을 수 있습니다.
